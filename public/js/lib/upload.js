...
var Upload = /** @class */ (function () {
    function Upload(element_id, URL) {
        this.fileID = 1;
        this.docID = 0;
        this.URL = '';
        this.ELEMENT_NOT_FOUND = ' !! Obj not found !!';
    ...
    Upload.prototype.clickMoreFile = function () {
        var file_container = document.getElementById(this.doc_id);
        if (file_container !== null) {
            var obj = document.createElement("INPUT");
            var obj_id = "f_" + this.fileID;
    ...
    Upload.prototype.newElement = function (file_id, fileName) {
        var objDiv = document.getElementById(file_id);
